            ...
            <ul class="column-box slideJs">
                <li class="listitem-left">
                    <div class="listitem-left__box03">
                        ...
                        <div class="listitem-left__text01 pc">
                            ホームページは公開してからが本番となります。弊社ではサイト公開後もアクセス解析やSEO対策等の様々な施策をご提案しながら、きめ細やかなアフターサポートをしてまいります。
                        </div>
                    </div>
                </li>
                <li class="listitem-right">
            ...
            <div class="flow__box">
                <ul class="slideJs">
                    ...
                    <li class="flow__box_line">
                        ...
                        <div class="flow__box_text">
                            ...
                            確認後、弊社担当者から早急にご連絡させていただきます。その後、お客様の希望するWEBサイトのイメージや方向性、搭載する機能から全体のスケジュール等、詳細をヒアリングさせていただきます。
                        </div>
                    </li>
                </ul>
                <ul class="slideJs">
                    ...
                    <li class="flow__box_line">
                        ...
                        <div class="flow__box_text">
                            ヒアリングさせていただいた内容をもとに、WEBサイトの基本仕様を策定していきます。また、この時点で概算のお見積りを作成・提出いたしますのでご確認・ご検討ください。
                        </div>
                    </li>
                </ul>
                <ul class="slideJs">
                ...
                <ul class="slideJs">
                    ...
                    <li class="flow__box_line_end">
                        ...
                        <div class="flow__box_text">
                            ホームページは公開後が本番です。更新作業やメンテナンスはもちろん、運用開始しながら出てきた問題点や修正点など、さまざまなメンテナンスやサポートを実施していきます。また、アクセス状況の解析や継続的なSEO対策等でホームページのパフォーマンスをさらに高める様々なオプション施策をご用意しておりますのでぜひご利用ください。
                        </div>
                    </li>
                </ul>
            </div>
